...
const ReactInstaStories = function (props: ReactInstaStoriesProps) {
    ...
    }, [props.stories, props.renderers, renderers]);
...
const generateStories = (stories: Story[], renderers: { Crenderer: Renderer, tester: Tester }[]) => {
    return stories.map(s => {
        ...
        let Crenderer = getRenderer(story, renderers);
        story.originalContent = story.content;
        story.content = Crenderer;
        return story
    })
};
